...
public static class ShumwayDebugHelper
{
    ...
    internal static DebugChannel? Channel
    {
        ...
        set
        {
            ...
            if (value is null)
            {
                ...
                Shumway.Core.Debugging.ShumwayDebugHost.OnSetFrameVariable = null;
            ...
            else
            {
                ...
                Shumway.Core.Debugging.ShumwayDebugHost.OnSetFrameVariable = SetFrameVariable;
    ...
    /// <summary>ADR-035 D5+ — the Watch-window destructive variable edit, plain-text
    /// side.</summary>
    public static string SetFrameVariable(int frameIndex, string varName, string termText)
    {
        ChannelDebugSession? session = Session;
        return session is null
            ? "no debug session is running"
            : session.SetFrameVariable(frameIndex, varName, termText);
    }
