...
public static class BytecodeIO
{
    ...
    /// <summary>Chunk 151a: read a 4-byte int across a split
    ...
    /// chunk-151b's problem — bytecode emission always writes a
    ...
    /// <summary>Chunk 151a: <see cref="ProgramView"/> overload —
