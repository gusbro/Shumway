% Coroutining: goal suspension on variable binding.
% Opt-in: PrologEngine.UseCoroutining() or use_module(library(coroutining))
% loads the bundle baked from this file at build time.
%
