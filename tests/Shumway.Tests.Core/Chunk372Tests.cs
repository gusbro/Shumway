...
/// <see cref="Activation.RegionReturnCursor"/> Cp-decode used by a region method's
...
public class Chunk372Tests
{
    ...
    public void Marker_IntoThisRegion_ReturnsCursor()
    {
        ...
        e.SetCp(Activation.EncodeResumeMarker(7, 3));
    ...
    {
        var e = new Activation();
        e.SetCp(Activation.EncodeResumeMarker(9, 2));
    ...
    {
        var e = new Activation();
        e.SetCp(Activation.EncodeResumeMarker(7, 0));
